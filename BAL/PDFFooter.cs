...
namespace BAL
{
    ...
    public class QCPDFFooter : PdfPageEventHelper
    {
        string _strName = "";
        public QCPDFFooter(string strName)
        {
            _strName = strName;
        }
        ...
        public override void OnEndPage(PdfWriter writer, iTextSharp.text.Document document)
        {
            ...
            PdfPCell cell;
            tabFot.TotalWidth = document.PageSize.Width - document.LeftMargin - document.RightMargin;
            cell = new PdfPCell(new Phrase("Tested By (QC Incharge)", CommonFunction.font10));
            cell.Border = Rectangle.NO_BORDER;
            cell.HorizontalAlignment = Rectangle.ALIGN_CENTER;
            cell.Colspan = tabFot.NumberOfColumns / 2;
            tabFot.AddCell(cell);
            cell = new PdfPCell(new Phrase("Approved By (Manager Incharge)", CommonFunction.font10));
            cell.Border = Rectangle.NO_BORDER;
            cell.HorizontalAlignment = Rectangle.ALIGN_CENTER;
            cell.Colspan = tabFot.NumberOfColumns / 2;
            tabFot.AddCell(cell);
            ...
            //cell.HorizontalAlignment = Rectangle.ALIGN_RIGHT;
            //cell.Colspan = tabFot.NumberOfColumns;
            //cell.Border = Rectangle.NO_BORDER;
            //tabFot.AddCell(cell);
            //cell = new PdfPCell(new Phrase(_strName, CommonFunction.font10));
            //cell.HorizontalAlignment = Rectangle.ALIGN_LEFT;
